...
REM Create symbolic link from AppData\Roaming\herdr\config.toml to Dotfiles\herdr\config.win.toml
mklink "%APPDATA%\herdr\config.toml" "%SCRIPT_DIR%\config.win.toml"
if errorlevel 1 (
